...
CREATE TABLE `order_returns` (
  ...
  `return_evidence` json DEFAULT NULL COMMENT 'Danh sách URL ảnh/video minh chứng',
  `return_rejected_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Lý do admin từ chối hoàn hàng',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
