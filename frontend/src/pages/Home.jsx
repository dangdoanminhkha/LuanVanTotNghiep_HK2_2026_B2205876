          ...
          <div className="relative overflow-hidden rounded-2xl shadow-lg">
            ...
            <div className="absolute inset-0 flex items-end md:items-center">
              <div className="p-5 md:p-10 text-white max-w-2xl">
                <p className="text-xs md:text-sm uppercase tracking-[0.2em] text-white/90">Bitis Collection</p>
                ...
                <a
                  href="https://bitis.com.vn/collections/go-for-love-2026"
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block mt-4 md:mt-6 bg-white text-gray-900 px-5 py-2.5 rounded-lg font-semibold hover:bg-gray-100 transition"
                >
                  Xem bộ sưu tập
                </a>
              </div>
